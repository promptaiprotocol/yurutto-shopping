const CACHE="yurutto-shopping-v1-1-20260913";
const ASSETS=["./","./index.html","./data.js","./guide.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./favicon-32.png"];
